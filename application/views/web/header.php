        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url(); ?>">
                    <img src="<?php echo base_url();?>/asset/web/img/logo1.png" width="188px" height="50px">
                </a>
            </div>

            <div class="collapse navbar-collapse mega-menu navbar-responsive-collapse" id="myNavbar">
                <div class="container">
                    <ul class="nav navbar-nav navbar-right navbar-static">
                        ...
                        <li>
                            <a href="<?php echo base_url();?>index.php/web/pengumuman">
                            <i class="fa fa-bullhorn"></i> Pengumuman</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url();?>index.php/web/jadwal_kuliah">
                            <i class="fa fa-clock-o"></i> Jadwal Kuliah</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url();?>index.php/web/data_mahasiswa">
                            <i class="fa fa-users"></i> Data Mahasiswa</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url();?>index.php/web/data_dosen">
                            <i class="fa fa-user"></i> Data Dosen</a>
                        </li>
                         <li>
                            <a href="<?php echo base_url();?>index.php/web/struktur_organisasi">
